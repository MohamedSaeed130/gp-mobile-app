    ...
    <View style={styles.form}>
      ...
      <View style={styles.section}>
        ...
        <TextInput
          style={[
            styles.input,
            touched.firstName && !validateName(formData.firstName) && styles.inputError
          ]}
        ...
        <TextInput
          style={[
            styles.input,
            touched.lastName && !validateName(formData.lastName) && styles.inputError
          ]}
      ...
      <View style={styles.section}>
        ...
        <TextInput
          style={[
            styles.input,
            touched.email && !validateEmail(formData.email) && styles.inputError
          ]}
          placeholder="Email"
          placeholderTextColor={Colors.textLight}
        ...
        <TextInput
          style={[
            styles.input,
            touched.password && !validatePassword(formData.password) && styles.inputError
          ]}
